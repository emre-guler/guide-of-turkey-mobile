...
class Placestovisitscreen extends Component {
    constructor(props){
        super(props);
        this.state = {
            firstContainer: 'none',
                    ...
                    <View style={{display: this.state.secondContainer}}>
                        ...
                        <ScrollView style={{marginBottom: 100}}>
                            <View  style={{display: 'flex', flexDirection: 'row', flexWrap: 'wrap', justifyContent:'center'}}>
                                {this.props.placeToVisitData == "" ? null : this.props.placeToVisitData.map((data) => (<TouchableOpacity onPress={() => this.placeClicked(data.ID)}><List photoUrl={data.photoUrl} name={data.Name} /></TouchableOpacity>))}
                            </View>
                        </ScrollView>
                    </View>
                </View>
...
export default connect(maptStateToProps, mapDispatchToProps)(Placestovisitscreen);